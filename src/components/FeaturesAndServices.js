...
function FeaturesAndServices() {
    return (
        ...
        <section>
            <section className="bg-emerald dark:bg-gray-900 relative">
                ...
                <div className="  px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8 lg:py-20">
                    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                        ...
                        <p className="max-w-2xl mb-6 font-normal  text-gray-500 lg:mb-8 md:text-lg  lg:text-lg  dark:text-gray-400 mt-10">
                            Backend with vast experience and fully up to date skills set, at Enuke Software offer the best in class E-Prescription solution
                        </p>
                        <button type="button" className="text-white bg-orange-50 font-bold rounded-lg text-sm px-5 py-2.5 text-center mt-5">
                            Get Started Now
                        </button>
                    </div>
                </div>
                            ...
                            <div>
                                <div className="relative">
                                    <div className="w-20 h-20 bg-emerald-50 rounded-full" >
                                        <div className="w-16 h-16 absolute left-2 top-2 bg-amber-400 rounded-full" >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-12 h-12 absolute top-2 left-2 text-white">
                                ...
                                <p className="mb-7 text-lg font-normal text-gray-800">
                                    One of the best ways to improve your product deployment speed is to automate as much of the process as possible.
                                </p>
                            </div>
                        </article>
                        <div className="space-y-8 lg:pl-8">
                            <article className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0 mb-5">
                                <div className="relative">
                                    <div className="w-12 h-12 bg-orange-50 rounded-xl" >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 absolute top-3 left-3 text-white">
                                ...
                                <a
                                    href="#"
                                    className="inline-flex items-center font-bold text-orange-50 hover:underline dark:text-primary-500"
                                >
                                    Interest
                                    <svg
                            ...
                            <article className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0 mb-5">
                                ...
                                <p className="mb-4 text-gray-500 font-normal dark:text-gray-400">
                                    Set up a Git server is not difference on git such github, gitlab ...etc. We provide your account have git in AutomateX.
                                </p>
                                <a
                                    href="#"
                                    className="inline-flex items-center font-bold text-orange-50 hover:underline dark:text-primary-500"
                ...
                <section className="bg-emerald-50 dark:bg-gray-900">
                    <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-10">
                        <h4 className="text-md font-bold text-center text-blue-500 lg:text-3xl dark:text-white">How about deploy work?</h4>

                        <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-4">
                            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-emerald-50 rounded-xl dark:bg-gray-800">
                                <div className="relative">
                                    <div className="w-16 h-16 bg-white  rounded-full" >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 absolute top-4 left-4 text-orange-50">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </div>
                                </div>

                                <h1 className="text-lg font-bold text-gray-900 dark:text-white">Create acount</h1>

                                <p className="text-gray-500 dark:text-gray-300 font-normal">
                                    Your can register acccount with Email, Google, github, and Gitlab.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-white rounded-xl dark:bg-gray-800">
                                <div className="relative">
                                    <div className="w-16 h-16 bg-amber-400 rounded-full" >
                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-8 h-8 absolute top-4 left-4 text-white">
                                            <path stroke-linecap="round" stroke-linejoin="round" d="M12 6v6h4.5m4.5 0a9 9 0 11-18 0 9 9 0 0118 0z" />
                                        </svg>
                                    </div>
                                </div>

                                <h1 className="text-lg font-bold text-gray-900  dark:text-white"> Upload/Git Source</h1>

                                <p className="text-gray-500 dark:text-gray-300 font-normal">
                                    Can upload your source with two option like Upload zip or just using git repo.
                                </p>
                            ...
                            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-emerald-50 rounded-xl dark:bg-gray-800">
                                ...
                                <p className="text-gray-500 dark:text-gray-300 font-normal">
                                    Just a one click your project will automatic build, test and deploy.
                                </p>
                            </div>
                            ...
                            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-emerald-50 rounded-xl dark:bg-gray-800">
                                ...
                                <p className="text-gray-500 dark:text-gray-300 font-normal">
                                    After a few minutes it will success your will get app URL.
                                </p>
                            </div>
                        </div>
                    </div>
                ...
                <div className="bg-white dark:bg-neutral-900 w-full px-4 pt-16 pb-16" id="faq">
                    <h2 className="text-3xl font-bold text-blue-500 text-center pb-10">Our Tech Stack</h2>


                    <div class="text-md font-extrabold text-center text-orange-50 border-b ">
                        <ul class="flex flex-wrap justify-center space-x-2 mb-20">
                            <li class="me-2">
                                <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-800  dark:hover:text-gray-300">Backend</a>
                            </li>
                            <li class="me-2">
                                <a href="#" class="inline-block p-4  border-b-4 border-blue-600 rounded-t-lg active dark:text-blue-700 dark:border-blue-500" aria-current="page">Frontend</a>
                            </li>
                            <li class="me-2">
                                <a href="#" class="inline-block p-4 border-b-2 border-transparent rounded-t-lg hover:text-gray-800  dark:hover:text-gray-300">Database</a>
                            </li>

                        </ul>
                    </div>

                    <div className="max-w-screen-lg px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 bg-white dark:bg-transparent">
                        <div className="justify-center space-x-2 space-y-2 sm:flex sm:space-x-6 sm:space-y-0 ">
                ...
                <section className="bg-white dark:bg-gray-900">
                    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 mt-10">
                        <h2 className="max-w-lg mb-6 text-4xl font-bold text-blue-500 sm:text-4xl md:mx-auto block whitespace-nowrap">
                            Our Cloud Storage
                        </h2>
                    ...
                    <div className="mx-auto max-w-screen-xl px-4 py-8 lg:py-16">
                        <div className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
                            ...
                            <div className="col-span-6  text-center sm:mb-6 lg:mb-0 lg:text-left">
                                ...
                                <button type="button" className="text-white bg-orange-50 font-medium rounded-lg text-xs px-5 py-2.5 text-center mr-2   mb-0 mt-6">
                                    Learn more
                                </button>
                            </div>

                        </div>
                        <div className="mx-auto mt-8 max-w-screen-sm text-center lg:mb-16">
                            <button type="button" class="text-black shadow bg-white hover:bg-[#3b5998]/90 focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
                ...
                <div className="mb-8 grid max-w-screen-xl mx-auto row-gap-6 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div>
                                <h6 className="font-bold text-lg text-black">Automate your deployment process
                                    <p className="mt-5 text-sm text-gray-600 font-normal">
                    ...
                    <div className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div>
                                <h6 className="font-bold text-lg text-black">Infrastructure as code (IaC)
                                    <p className="mt-5 text-sm text-gray-600 font-normal">
                    ...
                    <div className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div>
                                <h6 className="font-bold text-lg text-black">Monitoring your deployment
                                    <p className="mt-5 text-sm text-gray-600 font-normal">
                    ...
                    <div className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div>
                                <h6 className="font-bold text-lg text-black">Containerization
                                    <p className="mt-5 text-sm text-gray-600 font-normal">
                    ...
                    <div className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div>
                                <h6 className="font-abold text-lg text-black">Code Reviews
                                    <p className="mt-5 text-sm text-gray-600 font-normal">
                    ...
                    <div className="flex flex-col justify-between p-5 bg-emerald-50 border-b-cyan-50 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div>
                                <h6 className="font-bold text-lg text-black">Use a cloud platform
                                    <p className="mt-5 text-sm text-gray-600 font-normal">
            ...
            <main className="bg-emerald-50 w-full mt-8 mb-8">
                <div className="flex justify-between max-w-screen-xl px-4 py-8 mx-auto mt-20">
                    ...
                    <div className="py-11">
                        <button type="button" className="text-white bg-orange-50 font-medium rounded-lg text-sm px-9 py-5 text-center">
                            WORK WITH US
                        </button>
                    </div>
                </div>
