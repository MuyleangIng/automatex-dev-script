            ...
            <section className="bg-emerald dark:bg-gray-900 relative">
                ...
                <div className="  px-4 py-10 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-full md:px-24 lg:px-8 lg:py-20">
                    <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                        ...
                        <p className="max-w-2xl mb-6 font-normal  text-gray-500 lg:mb-8 md:text-lg  lg:text-lg  dark:text-gray-400 mt-10">
                            Unlock the incredible power of AutomateX, revolutionizing product development speed. Accelerate your process, embrace rapid innovation, and experience a swift and efficient journey. Discover AutomateX's potential today.
                        </p>
                    ...
                    <div className="mb-16 grid gap-8 lg:grid-cols-3 ">
                                ...
                                <div className="relative">
                                    <div className="w-20 h-20 bg-slate-100 dark:bg-amber-400 rounded-full" >
                                        <div className="w-16 h-16 absolute left-2 top-2 bg-amber-400 dark:bg-white rounded-full" >
                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-12 h-12 absolute top-2 left-2  text-white dark:text-orange-100">
                        ...
                        <div className="space-y-8 lg:pl-8">
                            <article className="flex flex-col justify-between p-5 border-b-cyan-50 rounded-xl bg-slate-100 dark:bg-gray-800 shadow-0 mb-5">
                                ...
                                <p className="mb-4 text-gray-500 font-normal dark:text-gray-400">
                            ...
                            <div className="flex flex-col items-center p-6 space-y-3 text-center bg-white rounded-xl dark:bg-gray-800">
                                <div className="relative">
                                    <div className="w-16 h-16 bg-amber-400 rounded-full" >
                                        ...
                                        <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" class="w-8 h-8 absolute top-4 left-4 text-white">
                    ...
                    <div className="mx-auto max-w-screen-xl px-4 py-8 lg:py-16">
                        <div className="grid items-center gap-8 lg:grid-cols-12 lg:gap-12">
                            ...
                            <div className="col-span-6  text-center sm:mb-6 lg:mb-0 lg:text-left">
                                ...
                                <p className="mx-auto max-w-xl text-gray-500 dark:text-gray-400 md:text-lg lg:mx-0 xl:mb-8 font-normal xl:text-lg">
                                ...
                                <div className="flex items-center space-x-4">
                                    <div className="relative">
                                        <div className="w-12 h-12 bg-amber-400 rounded-full" >
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" id="Layer_1" data-name="Layer 1" viewBox="0 0 24 24" class="w-6 h-6 absolute top-3 left-3 text-white"><path d="M17,0c-3.925,0-7,1.757-7,4v4.378c-.906-.24-1.919-.378-3-.378-3.925,0-7,1.757-7,4v8c0,2.243,3.075,4,7,4s7-1.757,7-4v-.385c.933,.248,1.955,.385,3,.385,3.925,0,7-1.757,7-4V4c0-2.243-3.075-4-7-4Zm6,12c0,1.626-2.748,3-6,3-1.061,0-2.086-.151-3-.424v-2.576c0-.131-.013-.26-.033-.387,.938,.253,1.968,.387,3.033,.387,2.581,0,4.787-.762,6-1.92v1.92ZM1,14.08c1.213,1.158,3.419,1.92,6,1.92s4.787-.762,6-1.92v1.92c0,1.626-2.748,3-6,3s-6-1.374-6-3v-1.92ZM17,1c3.252,0,6,1.374,6,3s-2.748,3-6,3-6-1.374-6-3,2.748-3,6-3Zm-6,5.08c1.213,1.158,3.419,1.92,6,1.92s4.787-.762,6-1.92v1.92c0,1.626-2.748,3-6,3-1.297,0-2.531-.213-3.576-.613-.518-.688-1.36-1.27-2.424-1.688v-2.619Zm-4,2.92c3.252,0,6,1.374,6,3s-2.748,3-6,3-6-1.374-6-3,2.748-3,6-3Zm0,14c-3.252,0-6-1.374-6-3v-1.92c1.213,1.158,3.419,1.92,6,1.92s4.787-.762,6-1.92v1.92c0,1.626-2.748,3-6,3Zm10-4c-1.057,0-2.086-.149-3-.422v-2.962c.932,.248,1.953,.383,3,.383,2.581,0,4.787-.762,6-1.92v1.92c0,1.626-2.748,3-6,3Z" /></svg>
                        ...
                        <div className="mx-auto mt-10 max-w-screen-sm text-center lg:mb-16">
                            <button type="button" class="text-black shadow bg-white hover:bg-cool-blue-300 hover:text-white focus:ring-4 focus:outline-none focus:ring-[#3b5998]/50 font-medium rounded-lg text-sm px-5 py-2.5 text-center inline-flex items-center dark:focus:ring-[#3b5998]/55 me-2 mb-2">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 text-orange-50">
                ...
                <div className="mb-8 grid max-w-screen-xl mx-auto row-gap-6 gap-6 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2">
                    ...
                    <div className="flex flex-col justify-between p-5 bg-slate-100 dark:bg-gray-800 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div >
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 28" stroke-width="0.5" stroke="orange" className="w-12 h-12 text-orange-100" ><path d="M24,11V4.5c0-1.379-1.122-2.5-2.5-2.5h-3.293l-2-2h-3.707c-1.378,0-2.5,1.121-2.5,2.5v2.5H1V0H0V16.5c0,1.379,1.122,2.5,2.5,2.5h7.5v5h14v-6.5c0-1.379-1.122-2.5-2.5-2.5h-3.293l-2-2h-3.707c-1.378,0-2.5,1.121-2.5,2.5v2.5H2.5c-.827,0-1.5-.673-1.5-1.5V6H10v5h14ZM11,2.5c0-.827,.673-1.5,1.5-1.5h3.293l2,2h3.707c.827,0,1.5,.673,1.5,1.5v5.5H11V2.5Zm0,13c0-.827,.673-1.5,1.5-1.5h3.293l2,2h3.707c.827,0,1.5,.673,1.5,1.5v5.5H11v-7.5Z" /></svg>
                    ...
                    <div className="flex flex-col justify-between p-5 bg-slate-100 dark:bg-gray-800 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div >
                                ...
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 28" stroke-width="0.5" stroke="orange" className="w-12 h-12 text-orange-100" ><path d="m22,6h-8c-1.103,0-2,.897-2,2v16h12V8c0-1.103-.897-2-2-2Zm1,17h-10v-15c0-.551.448-1,1-1h8c.552,0,1,.449,1,1v15Zm-5-8c-1.654,0-3,1.346-3,3s1.346,3,3,3,3-1.346,3-3-1.346-3-3-3Zm0,5c-1.103,0-2-.897-2-2s.897-2,2-2,2,.897,2,2-.897,2-2,2Zm-1.5-8.5c0-.828.672-1.5,1.5-1.5s1.5.672,1.5,1.5-.672,1.5-1.5,1.5-1.5-.672-1.5-1.5ZM1,16h9v5h-5v-1h4v-3H0V2.5C0,1.122,1.121,0,2.5,0h16c1.379,0,2.5,1.122,2.5,2.5v1.5h-1v-1.5c0-.827-.673-1.5-1.5-1.5H2.5c-.827,0-1.5.673-1.5,1.5v13.5Z" /></svg>
                    ...
                    <div className="flex flex-col justify-between p-5 bg-slate-100 dark:bg-gray-800 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div >
                                {/* <?xml version="1.0" encoding="UTF-8"?> */}
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 28" stroke-width="0.5" stroke="orange" className="w-12 h-12 text-orange-100" >
                    ...
                    <div className="flex flex-col justify-between p-5 bg-slate-100 dark:bg-gray-800 rounded-md shadow-0">
                        ...
                        <div className="flex items-center space-x-4 space-y-9">
                            ...
                            <div >
                                {/* <?xml version="1.0" encoding="UTF-8"?> */}
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 28 28" stroke-width="0.5" stroke="orange" className="w-12 h-12 text-orange-100" ><path d="m20.5,0H3.5C1.57,0,0,1.57,0,3.5v13c0,1.93,1.57,3.5,3.5,3.5h3.605l3.898,3.284c.285.253.645.379,1.001.379.352,0,.702-.123.978-.368l3.985-3.295h3.532c1.93,0,3.5-1.57,3.5-3.5V3.5c0-1.93-1.57-3.5-3.5-3.5Zm2.5,16.5c0,1.378-1.121,2.5-2.5,2.5h-3.712c-.116,0-.229.041-.318.115l-4.138,3.421c-.189.168-.474.169-.674-.008l-4.048-3.41c-.09-.076-.204-.118-.322-.118h-3.788c-1.379,0-2.5-1.122-2.5-2.5V3.5c0-1.378,1.121-2.5,2.5-2.5h17c1.379,0,2.5,1.122,2.5,2.5v13ZM13.732,4.732l-6.707,6.707c-.651.651-1.025,1.554-1.025,2.475v1.586c0,.276.224.5.5.5h1.586c.936,0,1.814-.364,2.475-1.025l6.707-6.707c.473-.472.732-1.1.732-1.768s-.26-1.296-.732-1.768c-.975-.975-2.561-.975-3.535,0Zm2.828,2.828l-6.707,6.707c-.472.472-1.1.732-1.768.732h-1.086v-1.086c0-.658.267-1.302.732-1.768l6.707-6.707c.584-.585,1.537-.585,2.121,0,.283.283.439.66.439,1.061s-.156.777-.439,1.061Z" /></svg>


                            </div>

                            <div>
                                <h6 className="font-abold text-lg text-gray-900 dark:text-white">Code Reviews
                                    <p className="mt-5 text-sm text-gray-900 dark:text-white  font-normal">
                                        Code reviews are a process in which software developers review each other's code. This is done to identify and fix bugs, improve code quality, and share knowledge.
                                    </p>
                                </h6>
                            </div>
