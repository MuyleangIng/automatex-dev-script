...
function DeployMethod({formik}) {
    ...
    return (
        <>
            <h2 className="text-xl py-5 font-bold text-cyan-500 dark:text-white">
                Deployment Method:
            </h2>
            <div className="grid grid-cols-1 my-5 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-5 ">
