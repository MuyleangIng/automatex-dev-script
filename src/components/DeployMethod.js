...
function DeployMethod({formik}) {
    ...
    function methodTemplate({value,title,desc}) {
        return (
            <label htmlFor={value}
                   className={`w-full group h-20 px-2 border-2 rounded-xl hover:cursor-pointer hover:shadow-xl hover:border-cool-blue-80 focus:bg-yellow-50 focus:dark:bg-blue-950 active:bg-cool-blue-80 active:dark:bg-gray-800 ${onSelectedActive(value)}`}>
