...
function ErrorHandling({code,message}) {
    return (
        <>
            <div className="flex h-[calc(100vh-220px)] items-center justify-center w-full bg-white dark:bg-gray-900 dark:text-white">
                <div className="text-center">
                    ...
                    <p className="text-slate-600 mt-2 lg:text-3xl dark:text-slate-500">
                        {message}
                    </p>
                </div>
            </div>
