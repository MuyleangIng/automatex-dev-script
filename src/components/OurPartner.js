    ...
    return (
        <section className="bg-white dark:bg-gray-900">
            <div className="mx-auto max-w-screen-xl px-4 py-8 lg:py-16">
                <h2 data-aos="flip-left" className="mb-8 text-center text-3xl text-cool-blue-151 font-extrabold leading-tight tracking-tight text-gray-900 dark:text-white md:text-4xl lg:mb-16">
                    Our beloved partner
                </h2>
