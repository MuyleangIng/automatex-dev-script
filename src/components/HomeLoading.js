    ...
    return (
        <>
            ...
            <section
                ...
                <div className={"max-w-screen-xs w-auto  lg:max-w-screen-xl mx-auto  px-5 sm:px-0 py-14 md:py-36"}>
                    <div className={"justify-center flex mb-6 animate-pulse"}>
                        <div className="max-w-md mx-auto  ">
                            {/*text loading*/}
                            <div className={"flex items-center flex-col gap-5 sm:items-start"}>
                                <div className="w-44 h-10 bg-gray-200 rounded dark:bg-gray-700"></div>
                    ...
                    <div className={"justify-center flex"}>
                        <div className="w-96 grid-cols-1 items-center  sm:grid-cols-2 gap-4  animate-pulse">
                            <div className={"order-1"}>
                                <div
                                    className="flex items-center justify-center w-full h-96 bg-gray-300 rounded dark:bg-gray-700">
                                    <svg className="w-12 h-12 text-gray-200" xmlns="http://www.w3.org/2000/svg"
            ...
            <section
                className={"px-5 lg:px-0 bg-cover bg-center bg-no-repeat "}>
                <div className={"max-w-screen-xs lg:max-w-screen-xl mx-auto px-5 sm:px-0 py-14 md:py-36 animate-pulse"}>
                    <div className="">
                        <div className="max-w-md mx-auto ">
                            <div className={" items-center  gap-5 sm:items-start"}>
                                <div className={"flex justify-center mb-6"}>
                                    <div className="w-60 h-6  bg-gray-200 rounded dark:bg-gray-700"></div>
                                </div>
            ...
            <section
                ...
                <div
                    className={"max-w-screen-xs w-auto  lg:max-w-screen-xl mx-auto  px-5 sm:px-0 py-14 md:py-36 animate-pulse"}>
                    <div className={"justify-center flex mb-6"}>
                        <div className="max-w-md mx-auto  ">
                            <div className={"flex items-center flex-col gap-5 sm:items-start"}>
                                <div className="w-40 h-8 bg-gray-200 rounded dark:bg-gray-700"></div>
                            </div>
                        </div>
                    </div>
            ...
            <section
                ...
                <div className="bg-gray-500 bg-opacity-80 text-white animate-pulse">
                    <div className="max-w-screen-xl flex flex-col space-y-4 mx-auto py-48 text-center items-center">
                        <div className={"w-44 h-10 bg-gray-200 rounded dark:bg-gray-200"}></div>
                        <div className="w-80 h-9 bg-gray-200 rounded dark:bg-gray-200"></div>
                        <div className={" w-44 h-10 bg-gray-200 rounded dark:bg-gray-200"}></div>
                    </div>
                </div>
            </section>
