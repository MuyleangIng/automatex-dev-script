        ...
        <section className="{`bg-white ${theme === 'dark' ? 'dark:bg-gray-900' : 'dark:bg-gray-900'}  relative my-13">
                ...
                <div className="items-center lg:flex">
                    <div className="w-full lg:w-1/2">
                        <div className="lg:max-w-lg">
                            ...
                            <p className=" mb-5 mt-5 text-gray-600 dark:text-gray-400">At AutomateX we are on a mission to revolutionize the way you work. With AutomateX, you can say goodbye to manual tasks.</p>
                            <Button outline
                            >
                                Subscribe
                            </Button>
                    ...
                    <div className="flex items-center justify-center w-full mt-6 lg:mt-0 lg:w-1/2">
                        <Image width={100} height={100} unoptimized="true"   className="w-full h-full lg:max-w-3xl" src="/images/herosection1.png" alt="Catalogue-pana.svg" />
                    </div>
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 ${theme === 'dark' ? 'dark:bg-gray-900' : 'dark:bg-gray-900'}">
                <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                    <h2 className="max-w-lg mb-6 text-3xl font-extrabold text-black dark:text-orange-100 sm:text-4xl md:mx-auto block whitespace-nowrap">
                ...
                <div className=" grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col justify-between p-5 border-b-cyan-50 rounded-md shadow-0 bg-slate-100 dark:bg-gray-800">
                        <div>
                            ...
                            <h6 className="mb-2 font-bold text-lg text-black dark:text-white ">Integrated Platform </h6>
                    ...
                    <div className="flex flex-col justify-between p-5 border-b-cyan-50 rounded-md shadow-0 bg-slate-100 dark:bg-gray-800">
                        <div>
                            ...
                            <h6 className="mb-2 font-bold text-lg text-black dark:text-white">Personal Dashboard</h6>
                            <p className="mb-7 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div className="flex flex-col justify-between p-5 border-b-cyan-50 rounded-md shadow-0 bg-slate-100 dark:bg-gray-800">
                        <div>
                            ...
                            <h6 className="mb-2 font-bold text-lg text-black dark:text-white ">Organically grow</h6>
                            <p className="mb-7 text-sm text-gray-500 dark:text-gray-400">
            ...
            {/*Service Section */}
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12">
                <h2 className="max-w-lg mb-6 text-4xl font-extrabold text-black dark:text-white sm:text-4xl md:mx-auto block whitespace-nowrap">
                    Service
                </h2>
            </div>
            <main className="relative mb-5">
                {/* First Card */}
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 rounded-r-full mb-8 lg:mb-0 bg-white dark:bg-gray-900">
                    <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
                        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5 text-center lg:text-left text-black dark:text-gray-200">
                        ...
                        <div className="flex items-center justify-center lg:w-1/2">
                            <div className="w-2/5">
                                <Image width={100} height={100} unoptimized="true"   className="object-cover" src="/images/Service.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                {/* Second Card */}
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl mt-5 md:px-24 lg:px-8 lg:py-20 mb-8 lg:mb-0 bg-white  dark:bg-gray-900">
                    <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
                        <div className="flex items-center justify-center lg:w-1/2">
                            <div className="w-2/5">
                                <Image width={100} height={100} unoptimized="true"   className="object-cover" src="/images/cloud.png" alt="" />
                            </div>
                        </div>
                        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5 text-center lg:text-left text-black dark:text-gray-200">
                            <div className="max-w-xl mb-6">
                ...
                {/* Third Card */}
                <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full mt-5 lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 rounded-r-full mb-8 lg:mb-0 bg-white  dark:bg-gray-900">
                    <div className="flex flex-col items-center justify-between w-full mb-10 lg:flex-row">
                        <div className="mb-16 lg:mb-0 lg:max-w-lg lg:pr-5 text-center lg:text-left text-black dark:text-gray-200">
                            <div className="max-w-xl mb-6">
                                <h2 className="max-w-lg mb-6 text-3xl font-bold sm:text-4xl sm:leading-none">
                        ...
                        <div className="flex items-center justify-center lg:w-1/2">
                            <div className="w-2/5">
                                <Image width={100} height={100} unoptimized="true"   className="object-cover" src="/images/git.png" alt="" />
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div className="max-w-xl mb-10 md:mx-auto sm:text-center lg:max-w-2xl md:mb-12 mt-10">
                <h2 className="max-w-lg mb-6 text-4xl font-extrabold text-black sm:text-4xl md:mx-auto block whitespace-nowrap dark:text-white">
                    Our Feature
                </h2>
            </div>
            <section className="bg-white dark:bg-gray-900">
                <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-10">
                    <h4 className="text-md font-light text-center lg:text-3xl text-black dark:text-white">explore our <br/> awesome <span className="text-black dark:text-white">Components</span></h4>

                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-4">
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-slate-100 rounded-xl dark:bg-gray-800">
                            ...
                            <h1 className="text-xl font-semibold text-black dark:text-white">User Monitoring</h1>
                        ...
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-slate-100 rounded-xl dark:bg-gray-800">
                            ...
                            <h1 className="text-xl font-semibold text-black dark:text-white"> Rollback Version</h1>
                        ...
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-slate-100 rounded-xl dark:bg-gray-800">
                            <span className="inline-block p-3 text-black rounded-full dark:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-14 h-14 text-orange-200 dark:text-orange-100">
                            ...
                            <h1 className="text-xl font-semibold text-black dark:text-white">Cloude Storage</h1>
                        ...
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-slate-100 rounded-xl dark:bg-gray-800">
                            ...
                            <h1 className="text-xl font-semibold text-black dark:text-white">Simple & clean designs</h1>
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container grid grid-cols-1 gap-10 px-6 py-12 mx-auto lg:grid-cols-3">
                    <div className="flex items-center">
                        ...
                        <h1 className="mt-2 md:text-6xl font-bold text-orange-200 text-3xl dark:text-orange-100 !important">Why Us ?</h1>
            ...
            <main className="bg-sky-50 dark:bg-gray-800  w-full mt-8">
                <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
                    <div className="col-span-2 mb-8">
                        <h1 className="mt-2 md:text-5xl font-bold text-black text-3xl dark:text-white !important mb-4">Helping a local Business</h1>
                        <h1 className="mt-2 md:text-5xl font-bold text-black text-3xl dark:text-white !important mb-10">reinvent itself</h1>
                    ...
                    <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                        <div>
                            <svg className="w-8 h-8 mb-2 text-orange-200 md:w-12 md:h-12 dark:text-text-orange-100" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor">
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" className="w-8 h-8 mb-2 text-orange-200 md:w-12 md:h-12 dark:text-text-orange-100">
