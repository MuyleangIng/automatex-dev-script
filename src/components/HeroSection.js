        ...
        <section className="{`bg-white ${theme === 'dark' ? 'dark:bg-gray-900' : 'dark:bg-gray-900'}  relative my-13">
            ...
            <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20 ${theme === 'dark' ? 'dark:bg-gray-900' : 'dark:bg-gray-900'}">
                ...
                <div className=" grid gap-4 row-gap-5 sm:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col justify-between p-5 border-b-cyan-50 rounded-md shadow-0 bg-white dark:bg-gray-800">
                        <div>
                            <div className=" flex items-center justify-center w-16 h-16 mb-4 rounded-full">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-14 h-14 text-black dark:text-orange-100">
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-10">
                    ...
                    <div className="grid grid-cols-1 gap-8 mt-8 xl:mt-12 xl:gap-16 md:grid-cols-2 xl:grid-cols-4">
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-slate-50 rounded-xl dark:bg-gray-800">
                        ...
                        <div className="flex flex-col items-center p-6 space-y-3 text-center bg-slate-50 rounded-xl dark:bg-gray-800">
                            <span className="inline-block p-3 text-black rounded-full dark:text-white">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-14 h-14 text-black dark:text-orange-100">
            ...
            <section className="bg-white dark:bg-gray-900">
                <div className="container grid grid-cols-1 gap-10 px-6 py-12 mx-auto lg:grid-cols-3">
                    <div className="flex items-center">
                        ...
                        <h1 className="mt-2 md:text-6xl font-bold text-black text-3xl dark:text-orange-100 !important">Why Us ?</h1>
            ...
            <main className="bg-sky-50 dark:bg-gray-800  w-full mt-8">
                <div className="items-center max-w-screen-xl px-4 py-8 mx-auto lg:grid lg:grid-cols-4 lg:gap-16 xl:gap-24 lg:py-24 lg:px-6">
                    ...
                    <div className="col-span-2 space-y-8 md:grid md:grid-cols-2 md:gap-12 md:space-y-0">
                        <div>
                            <svg className="w-8 h-8 mb-2 text-black md:w-12 md:h-12 dark:text-purple-500" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor">
                        ...
                        <div>
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-8 h-8 mb-2 text-black md:w-12 md:h-12 dark:text-purple-500">
