    ...
    return (<section className="bg-gray-50 dark:bg-gray-900">
            <div className="mx-auto max-w-screen-xl px-4 py-8 sm:py-16 lg:px-6">
                <div className="max-w-xl md:mx-auto text-center lg:max-w-2xl md:mb-12">
                    ...
                    <p data-aos="fade-up-right" className="text-gray-500 lg:text-lg lg:mt-6 dark:text-gray-300 sm:text-lg  mt-5">
                ...
                <div
                    ...
                    <Card  data-aos="flip-right">
                        <div className="flex items-center justify-center">
                            <div className="flex h-10 w-10 items-center justify-center rounded bg-primary-100 dark:bg-primary-900 lg:h-10 lg:w-10">
                        ...
                        <h3 className="lg:text-xl text-base font-bold dark:text-white text-center">User Monitoring</h3>
                    ...
                    <Card data-aos="flip-right">
                        ...
                        <h3 className="lg:text-xl text-base font-bold dark:text-white text-center"> Rollback Version</h3>
                        <p className="text-gray-500 lg:text-lg text-base dark:text-gray-400 text-center">
                    ...
                    <Card  data-aos="flip-right">
                        ...
                        <h3 className="lg:text-xl text-base font-bold dark:text-white text-center">
                            Cloude Storage
                        </h3>
                        <p className="text-gray-500 lg:text-lg text-base dark:text-gray-400 text-center">
