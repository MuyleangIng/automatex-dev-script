            ...
            <section className="bg-gray-50 dark:bg-gray-900">
                ...
                <div className="mx-auto max-w-screen-xl px-4 py-8 lg:px-6 lg:py-16">
                    ...
                    <div className="mt-8 grid gap-6 sm:grid-cols-2 lg:mt-12 lg:grid-cols-4">
                        ...
                        >
                            <div
                                className="mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-teal-100 dark:bg-teal-900 lg:h-12 lg:w-12">
                                <svg
                                    aria-hidden
                        ...
                        >
                            <div
                                className="mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-purple-100 dark:bg-purple-900 lg:h-12 lg:w-12">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                                    <path
                        ...
                        >
                            <div
                                className="mx-auto mb-4 flex h-10 w-10 items-center justify-center rounded-lg bg-green-100 dark:bg-green-900 lg:h-12 lg:w-12">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"
                                     fill="none">
                                    <path
