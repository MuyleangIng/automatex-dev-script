...
function SectionAppDb(props) {
    return (
        <>
            <div
                className="flex flex-col sm:flex-row justify-between items-center sm:py-6 sm:px-6 md:px-12 lg:px-24 xl:px-32">
                <div className="text-center sm:text-left mb-6 sm:mb-0">
                    <b className="font-bold text-2xl sm:text-4xl">Database</b>
                    <p className="text-base sm:text-lg mt-5 xl:mt-6 sm:mt-0">
            ...
            <div className="relative flex justify-center items-center w-full sm:w-5/6 mx-4 sm:mx-24 my-8 h-modal bg-slate-200 dark:bg-gray-800 rounded-xl">
                <div className="flex flex-col items-center bg-whitesmoke rounded-lg w-full max-w-3xl p-8">
                    <div>
                        <div className="relative">
                            <div className="w-20 h-20 bg-white dark:bg-whitesmoke rounded-xl">

                                <svg viewBox="0 0 1792 1792" xmlns="http://www.w3.org/2000/svg"
                                     className="w-10 h-10 absolute top-5 left-5 text-white">
                                    <path
                                        ...
                                        fill="#000000" className="fill-000000"></path>
                                </svg>
                    ...
                    <div className="text-3xl mt-7 text-center">
                        <b className="leading-[30px]">Create Database</b>
                        <p className="text-lg leading-[30px] w-80 text-center mt-5">
                            Create database and store that you can connect to your team’s project
                        </p>
                    </div>

                    <ul className="mt-10 bg-white max-w-xl mx-auto text-sm block font-medium text-center text-gray-500 rounded-lg shadow dark:shadow-lg dark:divide-gray-700 dark:text-gray-400 ">
                        <li className="w-full px-5 py-5 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 border-b dark:bg-gray-900 ">

                            <div className="flex ">

                                <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 mt-1"
                                ...
                                <span className={"md-text-sm ml-3 text-gray-950 font-bold dark:text-gray-300"}>Postgres
                                    <p className="font-normal mt-2">Relational</p>
                                </span>

                            </div>
                            <div>
                                <Link href={`/app/deploy-db/create-db`}>
                                    <button
                                        className="rounded-lg bg-transparent py-2.5 px-5 text-sm text-gray-950 dark:text-gray-300 border font-medium hover:bg-gray-800 hover:text-white"
                                        href="app/deploy-db/create-db">
                                        Create
                                    </button>
                                </Link>
                            </div>
                        ...
                        <li className="w-full px-5 py-5 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 border-b dark:bg-gray-900">
                            ...
                            <div className="flex ">
                                ...
                                <svg className="w-10 h-10 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24"
                                     id="mongodb">
                                    <path fill="#FFF"
                                ...
                                <span className={"ml-3 md:text-sm text-gray-950 font-bold dark:text-gray-300"}>MongoDB
                                    <p className="font-normal mt-2">NoSQL</p>
                                </span>
                            ...
                            <div>
                                <Link href={`/app/deploy-db/create-db`}>
                                    <button
                                        className="dark:text-gray-300 rounded-lg bg-transparent py-2.5 px-5 text-sm text-gray-950 border font-medium hover:bg-gray-800 hover:text-white ">
                                        Create
                                    </button>
                                </Link>
                            </div>
                        ...
                        <li className="w-full px-5 py-5 grid grid-cols-2 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-2 xl:grid-cols-2 gap-4 border-b dark:bg-gray-900 ">
                            ...
                            <div className="flex items-center ">
                                ...
                                <svg className="w-10 h-10 mt-1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 128 128"
                                     id="mysql">
                                    <path fill="#00618A"
                                ...
                                <span className={"ml-3 md:text-sm text-gray-950 font-bold dark:text-gray-300"}>MySQL
                                    <p className="font-normal mt-2">Versatile</p>
                                </span>
                            ...
                            <div>
                                <Link href={`/app/deploy-db/create-db`}>
                                    <button
                                        className="dark:text-gray-300 rounded-lg bg-transparent py-2.5 px-5 text-sm text-gray-950 border font-medium hover:bg-gray-800 hover:text-white dark:hover-bg-gray-900 ">
                                        Create
                                    </button>
                                </Link>
                            </div>
