            ...
            <div className=" relative flex justify-center items-center w-5/6 mx-24 my-8 h-modal bg-slate-200 dark:bg-gray-800 rounded-xl">
                <div className="flex flex-col items-center bg-whitesmoke rounded-lg w-full max-w-3xl p-8">
                    ...
                    <ul className="mt-10 bg-white  max-w-xl mx-auto text-sm block font-medium text-center text-gray-500 rounded-lg shadow dark:shadow-lg dark:divide-gray-700 dark:text-gray-400 ">
                        <li className="w-full px-5 py-5 grid grid-cols-2 gap-60 border-b dark:bg-gray-900 ">
                            ...
                            <div className="flex ">
                                ...
                                <span className={"md-text-sm ml-3 text-gray-950 font-bold dark:text-gray-300"}>Postgres
                                    <p className="font-normal">Relational</p>
                                </span>
                        ...
                        <li className="w-full px-5 py-5 grid grid-cols-2 gap-60  border-b dark:bg-gray-900">
                            ...
                            <div className="flex ">
                                ...
                                <span className={"hidden md:inline text-gray-950 ml-3 font-bold dark:text-gray-300"}>MongoDB
                                    <p className="font-normal">NoSQL</p>
                                </span>
                        ...
                        <li className="w-full px-5 py-5 grid md:grid-cols-2 md:gap-60 dark:bg-gray-900 ">
                            ...
                            <div className="flex items-center ">
                                ...
                                <span className={"ml-3 md:text-sm text-gray-950 font-bold dark:text-gray-300"}>MySQL
                                    <p className="font-normal">Versatile</p>
                                </span>
