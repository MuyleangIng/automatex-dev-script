...
export default function Error() {
  return (
    <div className="min-h-[calc(100vh-128px)] flex items-center justify-center py-10 px-5 w-full rounded bg-gray-50 dark:bg-gray-800">
      <div className="text-center text-gray-900 dark:text-white">
        ...
        <h1 className="mt-5 text-2xl font-bold  lg:text-3xl">
          500 - Server Error
        </h1>
        <p className="mt-5 lg:text-[17px]">
