                    ...
                    <div className="p-6 space-y-4 md:space-y-6 sm:p-8">
                        ...
                        <button
                            ...
                            <div className="relative flex items-center space-x-4 justify-center">
                                ...
                                <span className="block w-max dark:text-gray-400 font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with Google</span>
                            </div>
                        </button>
                            ...
                            {session ? (
                                ...
                                >
                                    <div className="relative flex items-center space-x-4 justify-center">
                                        ...
                                        <span className="block dark:text-gray-400 w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">
                        ...
                        <button
                            ...
                            <div className="relative flex items-center space-x-4 justify-center">
                                ...
                                <span className="block dark:text-gray-400 w-max font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with Gitlab</span>
                            </div>
                        </button>
