                        ...
                        <form className=" space-y-4 md:space-y-6" action="#">
                            ...
                            <button
                                ...
                                <div className="relative flex items-center space-x-4 justify-center">
                                    ...
                                    <span className="block w-max font-semibold tracking-wide text-gray-700 dark:text-gray-400 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with Google</span>
                                </div>
                            </button>
                            ...
                            <button
                                ...
                                className="w-full group h-12 px-6 border-2 border-gray-200 rounded-lg transition duration-300 hover:border-yellow-300 focus:bg-yellow-50 active:bg-yellow-100">
                                <div className="relative flex items-center space-x-4 justify-center">
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" className="absolute left-0 w-5 text-gray-700 dark:text-gray-400" viewBox="0 0 16 16">
                                    ...
                                    <span className="block w-max dark:text-gray-400 font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with Github</span>
                                </div>
                            </button>
                            <button
                                ...
                                <div className="relative flex items-center space-x-4 justify-center">
                                    ...
                                    <span className="block w-max dark:text-gray-400 font-semibold tracking-wide text-gray-700 text-sm transition duration-300 group-hover:text-blue-600 sm:text-base">Continue with Gitlab</span>
                                </div>
                            </button>
            ...
            {isModalOpen && (
                <div className="fixed z-10 inset-0 overflow-y-auto ">
                    <div className="flex items-center justify-center min-h-screen p-4 text-center">
                        ...
                        <div className="relative inline-block p-6 bg-white dark:bg-gray-800 rounded-lg text-left shadow-xl">
