                ...
                <div
                    ...
                    <div>
                        ...
                        <p className="mb-6 text-gray-500 dark:text-gray-400 md:text-lg">
                            At AutomateX, we are on a mission to revolutionize the way businesses operate by harnessing
                            the power of automation. In a fast-paced world, where time is of the essence, we believe in
